...
class LoginPage:
    ...
    def __init__(self, window):
        ...
        def main():
            ...
            e2 = StringVar(window)
            e2.set("Yes") # default value

            w = OptionMenu(window, e2, "Yes","No")
            w.place(x = 747, y = 548,
                width = 565,
                height = 29)
            ...
            entry3_bg = canvas.create_image(
                ...
                image = entry3_img)
            e3 = StringVar(window)
            e3.set("Yes") # default value

            w = OptionMenu(window, e3, "Yes","No")
            w.place(x = 747, y = 428,
                width = 565,
                height = 29)
            ...
            entry6_bg = canvas.create_image(
                ...
                image = entry6_img)
            e6 = StringVar(window)
            e6.set("Yes") # default value

            w = OptionMenu(window, e6, "Yes","No")
            w.place(x = 106, y = 788,
                width = 565,
                height = 29)
            ...
            e10 = StringVar(window)
            e10.set("Yes") # default value

            w = OptionMenu(window, e10, "Yes","No")
            w.place(x = 106, y = 308,
                width = 565,
                height = 29)
